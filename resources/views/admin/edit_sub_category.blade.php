                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <form action="{{ route('adminsubcategory') }}" method="post">
                                ...
                                <input type="hidden" name="sub_cat" value="{{ $sub_cat->id }}">
                                <div class="form-group">
                                    <label for="name" style="color: #000000;">Sub-category Name</label>
                                    <input type="text" class="form-control form-control-sm" id="name" name="name"
                                           placeholder="Enter sub-category Name" value="{{ $sub_cat->name }}">
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-sm" id="cat_id" name="cat_id">
                                        ...
                                        @foreach($categories as $category)
                                            <option value="{{ $category->id }}" @if($category->id == $sub_cat->cat_id)
